...
result_lookup = {'takeyoursobstory': ['Claire', 'https://youtu.be/7Ec3zIyt4Yg'], #Aaron
                ...
                'turkeyontheside': ['Jen', 'https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExc3RwcTJjY2F6NW9haGJvemxvdmlleTNycGV3ZmVpOTZodWxudDU4MSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/RlkxV4vKnKqtXLj2qw/giphy.gif'], # 
                ...
                'giveusahand': ['Marcelina', 'https://media1.tenor.com/m/kYTF8A-XkYcAAAAd/snowman-dog.gif'], # Angela
                'whatapup': ['Aaron', 'https://media1.tenor.com/m/B-DElu_sxdoAAAAd/atv-sledding-pupper-atv.gif'],#Eric
